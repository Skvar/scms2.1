...
<div class='files-form'>
	<p onclick='ToggleOpenBlock("files-list<?= $Files['index']; ?>")'>Список приложенных файлов:</p>
	
	<div class='files-list files-list-largeicon<?= $Files['show'] ? ' files-list-open':''; ?>' id='files-list<?= $Files['index']; ?>'>
	<?php	
		$user = GetCurrentUser();
