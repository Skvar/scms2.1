...
<tr>
	<td>-/-</td>
	<td>Название:</td>
	<td><input type='text' value='<?php echo $Form['orgname'] ?>' id='org-name'/></td>
	<td></td>
</tr>
<tr>
	<td>-/-</td>
...
<td>-/-</td>
	<td>Описание:</td>
	<td><input type='text' value='<?php echo $Form['orgdescription'] ?>' id='org-description'/></td>
	<td></td>
</tr>
...
<hr>
<button type='button' class='normal-button' onclick="WriteFormData('<?php echo $Form['handler']; ?>','organizationForm','<?php echo $Form['arg']; ?>');">
